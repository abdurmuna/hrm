...
public class JobTitle {
	...
	public JobTitle(Integer jobId, String title, String description, String responsibility, Boolean status,
	...
	public String toString() {
		return "JobTitle [jobId=" + jobId + ", title=" + title + ", description=" + description
				+ ", responsibility=" + responsibility + ", status=" + status + ", filler1=" + filler1 + ", filler2="
